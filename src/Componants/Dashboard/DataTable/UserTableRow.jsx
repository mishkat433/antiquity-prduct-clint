...
const UserTableRow = ({ row, deleteHandle, allcheck, columnShow, }) => {
    ...
    return (
        <tr>
            ...
            {columnShow.role === "role" ? <td className='role-row'>{role === 'Admin' && <FcSelfServiceKiosk />} {role === 'Editor' && <FaPencilAlt />} {role === "Maintainer" && <FcSynchronize />} {role === 'Author' && <FcServices />} {role}</td> : undefined}
